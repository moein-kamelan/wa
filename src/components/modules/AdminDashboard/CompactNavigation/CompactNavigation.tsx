  ...
  return (
    <div className="flex flex-col bg-secondary w-28 pt-35 shrink-0 z-50">
      <ul className="flex flex-col items-center">
        ...
        <li className="w-full  ">
          <button
            className={"flex items-center justify-center text-white hover:text-primary w-full h-full py-7"}
            
          >
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M40.6933 33.9733L46.6666 28L40.6933 22.0267" stroke="currentColor" stroke-width="3.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M34.44 28H46.5033" stroke="currentColor" stroke-width="3.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M22.7733 28H27.3467" stroke="currentColor" stroke-width="3.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13.9767 15.12C11.0833 18.2933 9.33333 22.6567 9.33333 28C9.33333 39.6667 17.6867 46.6667 28 46.6667" stroke="currentColor" stroke-width="3.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M28 9.33331C25.55 9.33331 23.2167 9.72998 21.07 10.4766" stroke="currentColor" stroke-width="3.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
