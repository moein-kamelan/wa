...
function Stepper() {
  return (
 <div className="relative bg-secondary rounded-xl w-[70%] h-4 mx-auto mt-11 mb-[51px]">


     <div className="flex items-center justify-between w-full bottom-0 top-0 my-auto  absolute">
      <div className="bg-secondary rounded-full flex items-center justify-center w-[52px] h-[51px] text-white">
...
<path d="M12.25 22.75H22.75" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <div className="bg-primary text-secondary rounded-full flex items-center justify-center w-[52px] h-[51px]">
<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
