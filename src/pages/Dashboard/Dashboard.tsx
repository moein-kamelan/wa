...
function Dashboard() {
  ...
  return (
    <div className='flex min-h-screen h-screen '>
      ...
      <Sidebar/>
      <MobileSidebar isOpenSidebar={isOpenSidebar} onOpenSidebar={handleOpenSidebar}/>
      <div className='grow bg-neutral-tertiary relative overflow-hidden z-10 h-full'>
      ...
      <Outlet/>
      <div className={`hidden fixed inset-0 w-full h-full bg-[#075E54]/36 border border-neutral-tertiary z-10 ${isOpenSidebar && "!block lg:!hidden"}`} onClick={handleCloseSidebar}></div>
      </div>
