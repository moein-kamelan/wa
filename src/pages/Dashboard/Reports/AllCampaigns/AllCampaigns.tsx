...
function AllCampaigns() {
    ...
    <div className="grow pb-4 rounded-[20px] flex flex-col">
      <div>
        <div className="grid grid-cols-2 mb-25">
          <div className="flex flex-col gap-y-4 mt-1.5">
            <div className="bg-gradient-to-l from-neutral-tertiary to-secondary px-4.5 py-3 flex items-center w-fit rounded-tl-2xl translate-x-8 shadow-normal">
              <span className="text-white  text-5xl [text-shadow:_2px_2px_0_black,_-2px_-2px_0_#075E54] ml-3">
                نام کمپین
              </span>
            ...
            <div className="bg-gradient-to-l from-neutral-tertiary to-secondary px-4.5 py-3 flex items-center w-fit rounded-tl-2xl translate-x-8 shadow-normal">
              <span className="  text-4xl  ml-3 text-secondary">
                وضعیت پیام ها :{" "}
              </span>
              <span className="text-white  text-4xl ">۱۰۰/۵۳</span>
            </div>
        ...
        <div className=" min-h-[350px] bg-neutral-tertiary/47 rounded-[20px] p-3.5">
          ...
          <div
            className="relative    rounded-2xl border-[3px] border-secondary   mt-3  w-full overflow-auto max-h-[254px]    [&::-webkit-scrollbar]:w-3
  ...
  [&::-webkit-scrollbar-thumb]:bg-[#1DA45070]"
      ...
      {/* <div className="flex items-center  mb-5 gap-3 flex-wrap">
        ...
        <svg     className="shrink-0 size-8 md:size-11" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.77148 3.6665H34.2281C36.2631 3.6665 37.9315 5.33482 37.9315 7.36982V11.4398C37.9315 12.9248 36.9964 14.7765 36.0798 15.6932" stroke="#25D366" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M26.2534 34.9614C26.2534 36.0797 25.52 37.5464 24.585 38.1147L22 39.783C19.5984 41.268 16.2617 39.5997 16.2617 36.6297V26.8214C16.2617 25.5197 15.5284 23.8514 14.7767 22.9347L7.73664 15.528C6.80164 14.593 6.06836 12.943 6.06836 11.8247" stroke="#25D366" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M29.4619 30.2865C32.702 30.2865 35.3286 27.66 35.3286 24.4199C35.3286 21.1798 32.702 18.5532 29.4619 18.5532C26.2218 18.5532 23.5952 21.1798 23.5952 24.4199C23.5952 27.66 26.2218 30.2865 29.4619 30.2865Z" stroke="#25D366" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M36.4286 31.3866L34.5952 29.5532" stroke="#25D366" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
 ...
 <div className="flex flex-col w-full grow" >
           <div className="grow max-h-[523px]    overflow-y-auto overflow-x-auto [&::-webkit-scrollbar]:w-3
  [&::-webkit-scrollbar-track]:rounded-full
  [&::-webkit-scrollbar-track]:w-9/12
        ...
        <table className="  w-full border-collapse text-center table-auto ">
          ...
          <tbody className="*:hover:bg-neutral-secondary">
            ...
            <tr className="p-2 ">
              ...
              <td className="border border-secondary py-3 lg:text-2xl">12/6</td>
              <td className="border border-secondary py-3">
                <button className="bg-primary rounded-[55px] text-white  shadow-[4px_4px_4px_0_rgba(0,0,0,0.25)] w-34 h-8 max-w-40 lg:h-12 text-2xl lg:text-[32px]">
                  فعال
                </button>
