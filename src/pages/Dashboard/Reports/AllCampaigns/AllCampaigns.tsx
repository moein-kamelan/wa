...
<div className="flex items-center gap-4">
  ...
  <div className="relative  w-full rounded-2xl border-[3px] border-secondary overflow-auto     overflow-y-auto mt-3 max-h-[254px]">
        <table className="w-full  border-collapse text-center table-auto ">
          <thead className="bg-neutral-primary/80 text-gray-black *:font-B-Nazanin xl:text-2xl  text-nowrap border-b-[3px] border-secondary">
            <tr>
              ...
              <th scope="col" className=" border border-secondary">
                <button className="flex items-center  justify-evenly  w-full py-2  ">
          ...
          <tbody className="*:hover:bg-neutral-secondary">
            <tr className="p-2 ">
              <td className="border border-secondary py-2 ">
                <label className="flex items-center justify-center w-full h-full ">
                  <div className="size-8 border border-secondary rounded-xl cursor-pointer"></div>
                  <input type="checkbox" className="hidden" />
                </label>
              </td>
              <td className="border border-secondary py-2  lg:text-2xl">
                admin
              </td>
            ...
            <tr className="p-2 ">
              ...
              <td className="border border-secondary py-2 px-3">
                <button
                  className="custom-btn  text-lg md:text-[20px] text-gray-black bg-neutral-tertiary w-[93px] h-7  "
                  onClick={() => setIsModalOpen(true)}
                >
            ...
            <tr className="p-2 ">
              ...
              <td className="border border-secondary py-2 px-3 lg:text-2xl">
                admin
              </td>
